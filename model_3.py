...
1. Feature size is 3. Volume renderer directly outputs RGB values
2. Neural renderer is adjusted accordingly
"""
...
class Model(GANModelDesc):
    ...
    @auto_reuse_variable_scope
    def neural_renderer(self, f_img, input_dim=M_F, output_dim=3, min_feat=32, img_size=256):
        """
        ...
        with tf.name_scope('losses'):
            with tf.name_scope('mask_losses'):
                ...
                with tf.name_scope('cycle_loss'):
                    ...
                    recon_cycle_loss = tf.reduce_mean(tf.abs(mask - gen_mask_cyc), name='recon_cycle_loss')
