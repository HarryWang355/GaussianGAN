        ...
        with tf.name_scope('losses'):
            with tf.name_scope('mask_losses'):
                ...
                with tf.name_scope('cycle_loss'):
                    ...
                    mask_recon_cycle_loss = tf.reduce_mean(tf.abs(mask - gen_mask_cyc), name='mask_recon_cycle_loss')
                    # img_recon_cycle_loss = tf.reduce_mean(tf.abs(img - gen_img_cyc), name='img_recon_cycle_loss')
                    img_recon_cycle_loss = tf.subtract(1., IoU_loss(mask, gen_mask_cyc), name='img_recon_cycle_loss')
