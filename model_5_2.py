...
1. IoU loss is used in place of l1 for mask reconstruction
2. resolution of feature/density map increased to 32*32
3. fixed bug about rotating twice
"""
        ...
        with argscope([Conv2D, Conv2DTranspose, tf.layers.conv2d]):
            ...
            with tf.variable_scope('gen'):
                ...
                with tf.variable_scope('gen_img'):
                    ...
                    # print(mus_rot)
                    # print(sigmas_rot)
                    feature_img_rot = self.volume_renderer(mus_org, sigmas_org, z_f, roty=randomrot,
                                                           M_S=M_S)
                    ...
                    density_map_rot = self.volume_renderer(mus_org, sigmas_org, z_f,
                                                           M_S=M_S,
